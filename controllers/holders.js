...
const calculateEcosystem = res => {
    ...
    res.forEach(r => {
        if (r.balance >= 1 && r.balance <= 999) {
            ...
            // results.octopus.holders.push(r)
        }
            ...
            // results.dolphin.holders.push(r)
        }
            ...
            // results.tigerShark.holders.push(r)
        }
            ...
            // results.greatWhite.holders.push(r)
        }
